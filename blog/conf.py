...
BLOG_TITLE = "SuJiKiNen's Blog"  # (translatable)
...
BLOG_EMAIL = "sujikinen@[dot]gmail[dot]com"
BLOG_DESCRIPTION = "Personal notes."  # (translatable)
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> - Powered by <a href="https://www.gnu.org/software/emacs/" rel="nofollow">Emacs</a> and <a href="https://getnikola.com" rel="nofollow">Nikola</a>       {license}'
